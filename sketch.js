...
function preload() {
  ...
  princessPeachImg= loadImage("assets/princessPeach.png")
  donkeyKongImg= loadImage("assets/donkeyKong.png")
...
function setup() {
  ...
  princessPeach= createSprite(50,100,20,20);
  princessPeach.addImage(princessPeachImg)
  princessPeach.scale= 0.5

  donkeyKong= createSprite(150,80,20,20);
  donkeyKong.addImage(donkeyKongImg)
  donkeyKong.scale= 0.8
